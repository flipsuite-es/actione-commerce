...
insert into public.pages (slug, title, body, sort) values
  ...
  ('cuidado', 'Cuidado de tus joyas', 'Nuestras joyas son de acero inoxidable dorado: no se oxidan, resisten el agua y no manchan la piel. Para que duren aún más, guárdalas secas y evita el perfume directo.', 3),
