...
- **Producto de PROVEEDOR (Smile Joyas) — NADA de publicidad engañosa (2026-07-02):** las piezas se compran a un proveedor, NO las diseñamos ni fabricamos. Prohibido afirmar/insinuar: "diseñamos", "diseñadas/hechas por nosotras", "nuestro estudio de diseño", "hecho/fabricado en España", "hecho a mano". SÍ es cierto y se puede decir: que **elegimos/seleccionamos con cuidado** (curación), atención cercana, "para el día a día y para regalar". Claims técnicos ("no se oxida", "no mancha la piel", "hipoalergénico/sin níquel") NO se usan como reclamo; solo material real y consejos de cuidado, sin sobre-prometer. Métodos de pago concretos (Visa/PayPal/Bizum) NO se anuncian hasta que estén activos. Aplica a web Y firmas de email. Pendiente confirmar con el usuario: ¿se envía desde España por nosotros? ¿se incluye packaging/tarjeta propios? (para poder afirmarlo o no).
