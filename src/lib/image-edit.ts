...
const REFLECTION_PROMPT =
  ...
  "CRITICAL: do NOT smooth, reshape, symmetrise, beautify or idealise the piece. Preserve its EXACT real silhouette and every real surface detail — any hammered/faceted areas, flat spots, small dents, bumps or irregularities must stay EXACTLY as in the original. The result must be the same real object with all its real imperfections; only the reflected scenery becomes white. Do NOT make it look more perfect than the original. " +
