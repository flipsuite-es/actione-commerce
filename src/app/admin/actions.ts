...
FÍJATE MUCHÍSIMO EN EL REFLEJO — es lo más importante. Examina CADA superficie metálica con lupa y compárala con la original: busca (a) siluetas humanas, cara, torso, brazos, manos, móvil/cámara; y (b) la HABITACIÓN reflejada — paredes, suelo, muebles, ventanas o tonos cálidos/beige/marrones del entorno. Si en la EDITADA todavía se distingue CUALQUIER rastro de una persona O de la habitación/entorno con tonos cálidos (aunque sea tenue o solo en una parte), REFLEJO_ELIMINADO debe ser BAJO (por debajo de 50). Sé ESTRICTO: ante la duda, cuenta como que el reflejo SIGUE. Solo pon un valor alto (>=80) si el metal refleja únicamente blanco/gradientes neutros limpios, como dentro de una caja blanca. (El color DORADO propio del metal es correcto y NO cuenta como reflejo del entorno.)
